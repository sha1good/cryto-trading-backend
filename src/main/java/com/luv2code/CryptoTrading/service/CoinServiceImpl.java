...
import com.luv2code.CryptoTrading.repository.CoinRepository;
...
//    private String API_KEY;
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        ...
        try {
            ...
            List<Coin> coinList = objMapper.readValue(res.getBody(), new TypeReference<List<Coin>>() {
            });
            return coinList;
    ...
    public String coinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            HttpEntity<String> entity = new HttpEntity<String>("parameters", headers);
            ResponseEntity<String> res = restTemplate.exchange(url, HttpMethod.GET, entity, String.class);
            JsonNode jsonNode = objMapper.readTree(res.getBody());
            Coin coin = new Coin();
